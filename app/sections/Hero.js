        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-24">
          ...
          <div className="lg:w-1/2 space-y-8 text-center lg:text-left">
            ...
            >
              ...
              modern technologies. Passionate about user experience and clean
              code.
            </motion.p>
            ...
            >
              <Link
                href="#projects"
                className="px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg font-medium flex items-center gap-2 hover:shadow-lg transition-all duration-300"
              >
              ...
              <Link
                href="#contact"
                className="px-6 py-3 border-2 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-lg font-medium flex items-center gap-2 hover:bg-gray-100 dark:hover:bg-gray-800 transition-all duration-300"
              >
            ...
            >
              {[
                ...
                <span
                  key={skill}
                  className="px-3 py-1 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-full text-sm text-gray-700 dark:text-gray-300 flex items-center gap-1"
                >
                  {skill === "React" && (
                    <CommandLineIcon className="w-4 h-4 text-blue-500" />
                  )}
                  {skill === "Figma" && (
                    <PaintBrushIcon className="w-4 h-4 text-pink-500" />
                  )}
                  {skill}
                </span>
              ))}
          ...
          >
            <div className="relative w-full max-w-lg aspect-square mx-auto">
              ...
              <div className="relative rounded-2xl overflow-hidden border-8 border-white dark:border-gray-800 shadow-2xl">
                <Image
                  src="/portfolio.jpeg" // Replace with your profile image
                  alt="Profile photo"
                  width={600}
                  height={600}
